...
<body class="bg-blue-900">
    <nav class="flex h-25 space-x-6 h-16 bg-blue-500 items-center text-xl pl-8 text-white font-bold">
        ...
        <a class="transition-all hover:shadow-2xl hover:scale-125" href="vendedores">Vendedores</a>
    ...
    <div class="flex w-full h-full justify-center items-center my-16">
        <div class="h-fit px-8 py-10 flex flex-col justify-around rounded-xl ml-12 bg-black">
            ...
            <thead>
                <tr>
                    <th class="border-4 border-white p-4">Puestos más buscados</th>
                </tr>
            </thead>
            <tbody>
                <?php
                    foreach($puestos as $puesto){
                        echo "<tr>";
                        echo "<td class=\"border-2 border-white p-4\">".$puesto['puesto']."</td>";
                        echo "</tr>";
                    }
                ?>
            </tbody>
